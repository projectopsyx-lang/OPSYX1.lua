...
local Config = {
    ...
    ServiceId       = 31267, -- Your PlatoBoost Service ID
    PlatoSecret     = "b952215a-a2ca-43b4-9841-3c090c4d51eb", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/projectopsyx-lang/OPSYX-key/refs/heads/main/OPSYX.lua", -- The raw URL of your main script
    ...
    HubDescription  = "⚠️Save Your Key In Your Clipboard 😁" -- The text shown below the title
}
