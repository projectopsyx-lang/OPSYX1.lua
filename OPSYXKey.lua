...
local Config = {
    ...
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/projectopsyx-lang/OPSYX1.lua/refs/heads/main/OPSYX1.lua", -- The raw URL of your main script
    ...
    HubDescription  = "⚠️Save Your KEY In Clipboard😁" -- The text shown below the title
}
